...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_document', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


        # Changing field 'Document.desc'
        db.alter_column(u'project_document', 'desc', self.gf('django.db.models.fields.CharField')(max_length=300))
        # Adding field 'Project.image'
        db.add_column(u'project_project', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='example.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.user'
        db.delete_column(u'project_document', 'user_id')


        # Changing field 'Document.desc'
        db.alter_column(u'project_document', 'desc', self.gf('django.db.models.fields.CharField')(max_length=1000))
